<div class="form-row">
    ...
    <div class="form-group col-md-4"><label>Diesel Liters</label><input type="number" step="0.01" name="diesel_liters" class="form-control" value="{{ old('diesel_liters', $entry?->diesel_liters) }}" required></div>
</div>
...
<button class="btn btn-primary">Save</button> <a class="btn btn-secondary" href="{{ route('diesel-usage.index') }}">Back</a>

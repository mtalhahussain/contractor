...
<form class="card card-body mb-3" method="GET">
    <div class="form-row">
        ...
        <div class="col-md-2"><select name="fuel_stock_id" class="form-control"><option value="">All Tanks / Stores</option>@foreach($stocks as $stock)<option value="{{ $stock->id }}" @selected(request('fuel_stock_id') == $stock->id)>{{ $stock->name }}</option>@endforeach</select></div>
